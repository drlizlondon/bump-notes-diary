...
const en: Dict = {
  ...
  "sum.share": "Share",
  "sum.header.title": "BumpNotes Pregnancy Summary",
  "sum.header.intro": "A factual summary from my own pregnancy record.",
  "sum.field.name": "Name",
  "sum.field.baby": "Baby",
...
const tr: Dict = {
  ...
  "sum.pdf": "PDF indir",
  "sum.share": "Paylaş",
  "sum.header.title": "BumpNotes Hamilelik Özeti",
  "sum.header.intro": "Kendi hamilelik kaydımdan oluşturulan olgusal bir özet.",
  "sum.field.name": "İsim",
