  ...
  head: () => ({
    meta: [
      { title: "Features — BumpNotes" },
      {
        name: "description",
        content:
          "Pregnancy timeline, symptom and feelings tracking, saved questions for your care team, and a shareable summary you control.",
      },
      { property: "og:title", content: "Features — BumpNotes" },
      {
        property: "og:description",
        content:
          "Pregnancy timeline, symptom and feelings tracking, saved questions, and a shareable summary.",
      },
    ],
  }),
    ...
    <PublicShell>
      <section className="px-5 sm:px-8 pt-8 sm:pt-14 pb-6 sm:pb-10">
        <div className="max-w-[820px] mx-auto text-center">
          ...
          <p className="mt-4 text-[15.5px] sm:text-lg text-ink-soft leading-relaxed max-w-[620px] mx-auto">
            A calm, private pregnancy notebook. Record what matters, organise it by week, and share
            a clear summary with your care team when you need to.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-[1120px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-5">
          {features.map((f) => (
            <div key={f.title} className="rounded-2xl bg-white border border-border p-5 sm:p-6">
              <span className="inline-grid place-items-center size-10 rounded-full bg-blush-soft text-primary">
                {f.icon}
              </span>
      ...
      <section className="px-5 sm:px-8 pb-20 sm:pb-28">
        <div className="max-w-[820px] mx-auto rounded-3xl bg-blush-soft/60 border border-border p-7 sm:p-10 text-center">
          ...
          <p className="mt-2 text-ink-soft text-[15px] sm:text-base">
