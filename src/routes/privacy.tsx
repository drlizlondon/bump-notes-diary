    ...
    <PublicShell>
      <article className="prose-bump px-5 sm:px-8 pt-10 pb-14 max-w-[680px] mx-auto">
        ...
        <p className="text-ink-soft leading-relaxed">
          BumpNotes is a private pregnancy notebook. Your record is saved to your BumpNotes account so
          you can sign in from any device and pick up where you left off. Only you can read it.
        </p>
        <p className="text-ink-soft leading-relaxed mt-3">
          We don't sell your data, we don't share your pregnancy record with advertisers, and we don't
          use it to train AI. You can view, download or permanently delete everything at any time from
        ...
        <div className="mt-8 rounded-2xl bg-blush-soft/60 border border-border p-5 space-y-2">
          ...
          <ul className="text-sm text-ink-soft space-y-1.5">
            ...
            <li>
              <Link to="/contact" className="text-primary font-medium hover:underline">Get in contact</Link>
            </li>
          </ul>
        </div>
      </article>
